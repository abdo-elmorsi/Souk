...
import { filteredPromoDeal } from '../../../../redux/reducers/deals/promoDealReducer'

const TableBrowsePg = ({ promoDeal }) => {
    const { t } = useTranslation()

    const inputRef = useRef('')
    const dispatch = useDispatch()
    const filterProducts = () => {
        dispatch(filteredPromoDeal(inputRef.current.value.toLowerCase()))
    }
    return (
        <>
            {/* Table Header */}
